...
class Decoder(nn.Module):
    def __init__(self, in_dim, h_dim, n_res_layers, res_h_dim):
        ...
        self.inverse_conv_stack = nn.Sequential(
            ...
            nn.ReLU(),
            nn.ConvTranspose2d(h_dim // 2, h_dim // 4, kernel_size=4, stride=2, padding=1),  # 160x120 → 320x240
            nn.ReLU(),
            nn.ConvTranspose2d(h_dim // 4, 3, kernel_size=4, stride=2, padding=1),  # 320x240 → 640x480
        )
